        ...
        if validInputs == true {
            Auth.auth().createUser(withEmail: email, password: password) { authResult, error in
                if (error?._code == nil) {
                    ...
                    let refreshAlert = UIAlertController(title: "Conta criada com sucesso", message: "Irá ser reencaminhado para o login.", preferredStyle: UIAlertController.Style.alert)
